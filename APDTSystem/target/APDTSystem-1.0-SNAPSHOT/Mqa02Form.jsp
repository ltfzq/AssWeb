...
<body>
  ...
  <div class="content">
       ...
       <center>
           ...
           <button style=" padding:2px; background-color: lightblue; border-radius: 5px;"><a href="${pageContext.request.contextPath}/Mqa02Form.jsp" style="color: black; text-decoration: none;">MQA-02</a></button>
