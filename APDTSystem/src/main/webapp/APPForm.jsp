...
<body>
  ...
  <div class="content">
       ...
       <center>
           ...
           <button style=" padding:2px; background-color: lightblue; border-radius: 5px;"><a href="${pageContext.request.contextPath}/APPForm.jsp" style="color: black; text-decoration: none;">App List</a></button>
      ...
      <fieldset style="border-radius: 5px;">
          ...
          <c:if test="${app == null}">
              <form action="${pageContext.request.contextPath}/app/insert" method="post">
          </c:if>
